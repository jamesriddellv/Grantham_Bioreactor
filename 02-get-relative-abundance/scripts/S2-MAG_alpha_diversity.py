...
get_ipython().system('jupyter nbconvert --to script 05-MAG_abundance_hill_number.ipynb --output /fs/ess/PAS1117/riddell26/Grantham_Bioreactor/02-get-relative-abundance/scripts/S2-MAG_alpha_diversity')
