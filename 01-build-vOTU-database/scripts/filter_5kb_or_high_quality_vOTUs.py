...
quality_contigs = df.loc[(df['contig_length'] > 5000) | ( (df['checkv_quality'] == 'High-quality') | (df['checkv_quality'] == 'Complete') )]
...
with open('../results/vOTU_clusters/checkv_5kb_or_high_quality_vOTUs.txt', 'w') as f:
