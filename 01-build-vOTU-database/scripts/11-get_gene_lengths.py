...
gff_file = '../results/genomad_vs2sop_sun2024_emerson2018_combined_vOTUs/vOTU_genes.gff'  # Replace with the path to your GFF file
output_file = '../results/genomad_vs2sop_sun2024_emerson2018_combined_vOTUs/vOTU_gene_lengths.tsv'  # Specify the desired output file path (tab-separated file)
