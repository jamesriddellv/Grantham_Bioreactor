...
gff_file = '/fs/scratch/Sullivan_Lab/JamesR/Grantham_Bioreactor/01-build-vOTU-database/results/MAGs/prodigal/prefix_MAGs.gff'  # Replace with the path to your GFF file
output_file = '/fs/scratch/Sullivan_Lab/JamesR/Grantham_Bioreactor/01-build-vOTU-database/results/MAGs/prodigal/prefix_MAGs_gene_lengths.tsv'  # Specify the desired output file path (tab-separated file)
