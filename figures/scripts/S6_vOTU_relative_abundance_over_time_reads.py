...
get_ipython().system('jupyter nbconvert --to script 004-vOTU-relative-abundance-over-time-reads.ipynb --output /fs/ess/PAS1117/riddell26/Grantham_Bioreactor/figures/scripts/S6_vOTU_relative_abundance_over_time_reads')
